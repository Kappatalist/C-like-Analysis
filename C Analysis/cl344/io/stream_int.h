...
/* Network stream flags.  Since there are quite a number of these and they're
   ...
   overall stream flags.  These are:
...
#define STREAM_NFLAG_LASTMSGR	0x0200	/* Last message in read exchange */
#define STREAM_NFLAG_LASTMSGW	0x0400	/* Last message in write exchange */
...
#define STREAM_NFLAG_MAX		0x1FFF	/* Maximum possible flag value */
