...
/* Self-test code for the correctness/safety mechanisms */
...
#if 0
	BYTE buffer[ 32 + 8 ], *bufPtr, savedValue;
#endif
...
#if 0
	bufPtr = insertBufferCookies( buffer, 32 );
	if( !checkBufferCookies( bufPtr, 32 - 8 ) )
...
/* Run internal-function self-tests */
